...
val mappingFileDevicePath = "/sdcard/decoroutinator/tests/android/gradle-plugin-mapping.txt"
...
android {
    namespace = "dev.reformator.stacktracedecoroutinator.tests.android.gradleplugintests"
    compileSdk = libs.versions.android.compile.sdk.get().toInt()
    defaultConfig {
        applicationId = "dev.reformator.stacktracedecoroutinator.tests.android.gradleplugintests"
        versionCode = 1
        versionName = "1.0"
        minSdk = 26
