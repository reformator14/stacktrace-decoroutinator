...
private val methodDefinitionRegex = Regex("""    ($NUMBER_REGEX):($NUMBER_REGEX):$CLASS_NAME_REGEX ($IDENTIFIER_REGEX)$PARAMETER_LIST_REGEX:($NUMBER_REGEX)(:$NUMBER_REGEX)? -> ($IDENTIFIER_REGEX)""")
